...
export function ActIILegacy() {
  ...
  return (
    <div
      ...
      {/* ── Content ── */}
      <div
        className="relative z-10 mx-auto px-(--page-gutter)"
        ...
        <motion.div
          ...
          <p
            className="mx-auto mt-6 font-serif text-sm leading-relaxed text-(--cream-muted) italic sm:text-base md:text-lg lg:text-xl"
            style={{ maxWidth: SPLASH_MAX_W }}>
            {ACT_II.splash}
          </p>
          <p
            className="mx-auto mt-5 text-xs leading-[1.7] text-(--text-dim) sm:text-[13px] sm:mt-6 md:text-sm lg:text-base"
            style={{ maxWidth: BODY_MAX_W }}>
            {ACT_II.body}
          </p>
        </motion.div>
        ...
        <motion.div ref={terminalRef} style={{ opacity: terminalOpacity }}>
          ...
          <motion.div
            ...
            style={{
              backgroundColor: TERMINAL_TITLE_BG,
